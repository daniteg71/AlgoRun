...
| Supervised binary relation validator (RoBERTa variant) | RoBERTa-base, same script (`train --arch roberta`) — **to be trained on Google Colab** (125M params, too heavy for the M2 laptop; snippet in README). Paste measured P/R/F1 here once run | M4 (second architecture) | Liu et al. (2019) arXiv:1907.11692 |
