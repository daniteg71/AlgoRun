...
#    - dataclasses per poter creare ogetti dataclass (classe per contendere dati) e trasformarli in dizionario
#    - typing per indicare che una funzione accetta una sequenza ordinata di valori
#    - numpy per convertire BPM in array e calcolare median, s.d., minimo e massimo, regressione lineare
...
#  questa è la funzione principale, riceve:ù
